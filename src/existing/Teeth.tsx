...
export default function Teeth() {
	...
	const { Next, Prev, setData } = useExistingContext();
	const handleClick = (e: any) => {
		setSelected((prev) => ({
			...prev,
			[e.target.dataset.key as keyof typeof prev]:
				!prev[e.target.dataset.key as keyof typeof prev],
		}));
	};
	const active = "transition fill-red-500";
	const inactive = "transition fill-white hover:fill-red-200";
	useEffect(() => {
		setData((prev: any) => ({ ...prev, teeth: selected }));
	}, [selected]);
	return (
		<>
			<Header name="Dental Chart" backRef="/type" />
			<h1 className="text-2xl font-bold text-neutral">
				Select the teeth that need treatment
			</h1>
			<div>
				<div>
					<svg
					...
					>
						...
						<g id="Spots">
							<polygon
								id="Tooth32"
								onClick={handleClick}
								className={selected[32] ? active : inactive}
								data-key="32"
		...
		80.7,375 73.7,371.3 	"
							...
							<polygon
								id="Tooth31"
								onClick={handleClick}
								className={selected[31] ? active : inactive}
								data-key="31"
		...
		46.7,476.7 37.7,446.3 39.7,438.3 43.3,432 49,426.7 56,424.7 65,424.7 	"
							...
							<polygon
								id="Tooth30"
								onClick={handleClick}
								className={selected[30] ? active : inactive}
								data-key="30"
		...
		60.3,529.7 56.3,523.7 51.7,511 47.7,494.7 47.7,488.3 50.3,483.3 55,479.7 67,476.7 	"
							...
							<polygon
								id="Tooth29"
								onClick={handleClick}
								className={selected[29] ? active : inactive}
								data-key="29"
		...
		98.3,578.3 88,579 82,575 75,565 69.3,552.3 67.3,542 69.7,536 74.3,531.7 84.3,528.3 	"
							...
							<path
								id="Tooth28"
								onClick={handleClick}
								className={selected[28] ? active : inactive}
								data-key="28"
		...
		l-7.3-7l-5-9l-2-10c0,0-0.7-7,0.3-7.3c1-0.3,5.3-6.7,5.3-6.7l9-5H117.3z"
							...
							<polygon
								id="Tooth27"
								onClick={handleClick}
								className={selected[27] ? active : inactive}
								data-key="27"
		...
		133.3,641.3 128.7,634.7 128.7,629 132.7,621.3 137.7,615 143.7,611 149.7,610 	"
							...
							<polygon
								id="Tooth26"
								onClick={handleClick}
								className={selected[26] ? active : inactive}
								data-key="26"
		...
		168,656.3 159.3,649.7 156.7,644 162,639.3 	"
							...
							<polygon
								id="Tooth25"
								onClick={handleClick}
								className={selected[25] ? active : inactive}
								data-key="25"
		...
		190.3,662.7 193,657.3 199.7,647.3 207,638 210.7,635.5 	"
							...
							<path
								id="Tooth24"
								onClick={handleClick}
								className={selected[24] ? active : inactive}
								data-key="24"
		...
		l-10,0.3h-10l-2-6.7l2.7-7.3L235.3,637z"
							...
							<polygon
								id="Tooth23"
								onClick={handleClick}
								className={selected[23] ? active : inactive}
								data-key="23"
		...
		292,643.3 291.3,650 287,655 280.7,658.7 272,660 265,660.7 261.3,657.3 261.7,650 263.7,637 264.3,627 	"
							...
							<polygon
								id="Tooth22"
								onClick={handleClick}
								className={selected[22] ? active : inactive}
								data-key="22"
		...
		321,630 321.3,620.3 317,614.3 308,608 298.3,607 291,609.3 287,612.3 286.7,617.7 287.3,624.7 	"
							...
							<polygon
								id="Tooth21"
								onClick={handleClick}
								className={selected[21] ? active : inactive}
								data-key="21"
		...
		342.7,604 337.7,609 328,612.7 320,613.3 315,611 308.3,604.7 306.7,598 307.3,591.3 309,584.7 312.7,578.3 318.3,571.7 	"
							...
							<polygon
								id="Tooth20"
								onClick={handleClick}
								className={selected[20] ? active : inactive}
								data-key="20"
		...
		381.3,524.3 374,520.7 363.7,516.3 356.3,515.3 351.3,518.3 346.3,524 340.3,534.3 336,546.7 	"
							...
							<path
								id="Tooth19"
								onClick={handleClick}
								className={selected[19] ? active : inactive}
								data-key="19"
		...
		c-0.3-1.3-0.3-11-0.3-11l3.7-14.3l3.7-7l5.3-6.7l8-2l9.7-0.7L398,470z"
							...
							<polygon
								id="Tooth18"
								onClick={handleClick}
								className={selected[18] ? active : inactive}
								data-key="18"
		...
		407.7,427.3 	"
							...
							<polygon
								id="Tooth17"
								onClick={handleClick}
								className={selected[17] ? active : inactive}
								data-key="17"
		...
		406.7,395 401,377.7 397.3,373 390.7,367.3 380,365 373,366.7 367.3,369 364,374.3 360,389 363.3,401.3 367.7,412.3 	"
							...
							<polygon
								id="Tooth16"
								onClick={handleClick}
								className={selected[16] ? active : inactive}
								data-key="16"
		...
		369,339.7 359,335 354.7,327.7 354.3,316 358.3,304 363.7,294 368.7,294.7 378.7,296 389,296 	"
							...
							<polygon
								id="Tooth15"
								onClick={handleClick}
								className={selected[15] ? active : inactive}
								data-key="15"
		...
		371,294.3 392,295 404.3,293.7 410,280.7 412,263.3 407.3,246.7 401,240.3 396,239.7 389.3,243 	"
							...
							<polygon
								id="Tooth14"
								onClick={handleClick}
								className={selected[14] ? active : inactive}
								data-key="14"
		...
		393,196 399.3,207 401.3,222.7 400,234.3 394.7,240.7 381.7,244.7 371,246 	"
							...
							<polygon
								id="Tooth13"
								onClick={handleClick}
								className={selected[13] ? active : inactive}
								data-key="13"
		...
		383.3,178.3 	"
							...
							<polygon
								id="Tooth12"
								onClick={handleClick}
								className={selected[12] ? active : inactive}
								data-key="12"
		...
		348.7,122.7 354.3,127.7 	"
							...
							<polygon
								id="Tooth11"
								onClick={handleClick}
								className={selected[11] ? active : inactive}
								data-key="11"
		...
		297.3,120.3 294,112 295.7,102.7 299,95 303.3,90 309.3,88 316.3,87.3 322.7,87.3 328,88.3 	"
							...
							<polygon
								id="Tooth10"
								onClick={handleClick}
								className={selected[10] ? active : inactive}
								data-key="10"
		...
		274.7,54.7 282,53 287.7,54.7 297.3,60.3 304,64.3 308.7,68.7 312.3,74 313,81 	"
							...
							<polygon
								id="Tooth9"
								onClick={handleClick}
								className={selected[9] ? active : inactive}
								data-key="9"
		...
		222,58.3 219,50 220,44.3 224.3,40.3 230,38.7 237.3,38.7 253,39.3 258.7,41.3 264.3,43.7 268.3,45.7 	"
							...
							<polygon
								id="Tooth8"
								onClick={handleClick}
								className={selected[8] ? active : inactive}
								data-key="8"
		...
		212.3,75.7 208,83 201.7,85.7 195.7,86.7 189.7,83.3 183.7,74.7 175,62 171.7,54 172.7,49.7 	"
							...
							<path
								id="Tooth7"
								onClick={handleClick}
								className={selected[7] ? active : inactive}
								data-key="7"
		...
		l-6.3-5.3l-1-4.3l1.3-5c0,0,3.3-6,4.3-6s5.3-6,6.3-6s10.3-4.7,10.3-4.7L167,55z"
							...
							<polygon
								id="Tooth6"
								onClick={handleClick}
								className={selected[6] ? active : inactive}
								data-key="6"
